...
export default function Profile() {
  ...
  const handleVerifyNIN = async () => {
    ...
    try {
      await fetchJSON(`${API_URL}/api/agent/verify-nin`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        ...
        {agentStatus === "pending" && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mt-10 rounded-3xl border border-yellow-200 bg-yellow-50 p-6 text-center sm:p-10"
          >
            <ShieldCheck
              size={60}
            ...
            <h2 className="mt-5 text-3xl font-bold text-yellow-700">
        ...
        {agentStatus === "approved" && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="mt-10 rounded-3xl border border-green-200 bg-green-50 p-6 text-center sm:p-10"
          >
            <CheckCircle2
              size={60}
                  ...
                  <button
                    ...
                    onClick={() =>
                      setShowPasswords((prev) => ({
                        ...
                        [field.key]:
                          !prev[
                            field.key as keyof typeof prev
                          ],
                      }))
                    }
            ...
            <div>
              ...
              <div className="mt-8 space-y-4">
                {[
                  ...
                  {
                    icon: Building2,
                    text: "Verified Luxury Dwells Badge",
                  },
                  {
                    icon: BriefcaseBusiness,
                    text: "Professional Agent Dashboard",
                  },
                  {
                    icon: ShieldCheck,
                    text: "Increased Buyer Trust & Visibility",
                  },
                ].map((item, i) => {
            ...
            >
              ...
              >
                ...
                <div className="mb-6 flex items-center rounded-xl border border-gray-200 px-4 py-3 focus-within:border-blue-600">
                  <BadgeCheck
                    size={20}
                    className="mr-3 shrink-0 text-blue-600"
                  />
